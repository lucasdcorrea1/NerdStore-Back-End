...
namespace NerdStore.Catalogo.Domain
{
    public class Produto : Entity, IAggregateRoot
    {
        ...
        public Dimencoes Dimencoes { get; private set; }

        public Categoria Categoria { get; private set; }

        public Produto(string nome, string descricaom, bool ativo, Decimal valor, Guid categiriaId, DateTime dataCadastro, string imagem, Dimencoes dimencoes)
        {
            Nome = nome;
