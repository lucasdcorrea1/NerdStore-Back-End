...
namespace NerdStore.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarExpressao(string pattern, string valor, string mesngem)
        {
            var regex = new Regex(pattern);
            if (!regex.IsMatch(valor))
            {
                throw new DomainException(mesngem);
            }
        }
        ...
        public static void ValidarSeMaiorIgualMinimo(int valor, int minimo, string mensagem)
        {
            if (valor >= minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaiorIgualMinimo(double valor, double minimo, string mensagem)
        {
            if (valor >= minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaiorIgualMinimo(decimal valor, decimal minimo, string mensagem)
        {
            if (valor >= minimo)
            {
                throw new DomainException(mensagem);
